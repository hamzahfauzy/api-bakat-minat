    ...
    var html = `<div style="margin:auto;">
                    ...
                    <table width="100%" border="1" cellpadding="5" cellspacing="0" style="font-size:8px!important">
                        ...
                        <tr style="font-weight:bold">
                            ...
                            <td style="text-align:center">:</td>
                            <td style="text-align:center"><b>${user.metas.nilai == undefined || user.metas.nilai.hasil == 'Tidak diketahui' ? 'Tidak diketahui' : user.metas.nilai.hasil.split(" - ")[0]}</b></td>
                            <td style="text-align:center"><b>${user.metas.nilai == undefined || user.metas.nilai.hasil == 'Tidak diketahui' ? 'Tidak diketahui' : user.metas.nilai.hasil.split(" - ")[1]}</b></td>
                            <td style="text-align:center"><b>${user.metas.nilai == undefined || user.metas.nilai.hasil == 'Tidak diketahui' ? 'Tidak diketahui' : user.metas.nilai.hasil.split(" - ")[2]}</b></td>
                        </tr>
                        <tr style="font-weight:bold">
                            <td>5.</td>
                    ...
                    <br>
                    <div style="text-align:right;font-size:10px!important;margin-right:100px;">Medan, ${today}</div>
